...
import 'package:presensi_mobile_apps/controller/exit_controller.dart';
...
class MapsPageExit extends StatefulWidget {
  MapsPageExit({super.key});
  @override
  _MapsPageExitState createState() => _MapsPageExitState();
}

class _MapsPageExitState extends State<MapsPageExit> {
  ...
  ExitController _exitController = ExitController();
  ...
  void _handleAbsensiKeluar() async {
    try {
      ...
      Exit exit = Exit(
        ...
        // status: status,
        exitNote: _noteController.text,
      );

      print('Exit Details:');
      // print('Day: ${entry.day}');
      print('Date: ${exit.date}');
      print('Month: ${exit.month}');
      print('Year: ${exit.year}');
      print('Time: ${exit.time}');
      print('Latitude: ${exit.latitude}');
      print('Longitude: ${exit.longitude}');
      // print('Status: ${exit.status}');
      print('Exit Note: ${exit.exitNote}');

      _exitController.postExit(exit);
      setState(() {
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              _handleAbsensiKeluar();
                            },
                            style: ElevatedButton.styleFrom(
                              backgroundColor: const Color(0xffC9002B),
